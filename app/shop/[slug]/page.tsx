          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="flex flex-col justify-center">
              <ScrollReveal delay={100}>
                <p className="font-mono text-[11px] tracking-[0.15em] uppercase text-forge-paper/60 mb-4">
                  {product.status}
                  {product.leadTime && (
                    <span className="text-forge-paper/40">
                      {" "}
              ...
              {maker && (
                <ScrollReveal delay={200}>
                  <Link
                    ...
                    className="font-sans text-[14px] font-light text-forge-paper/60 hover:text-forge-paper transition-colors duration-300 mb-6 inline-block"
                  >
              ...
              <ScrollReveal delay={350}>
                <div className="space-y-0 mb-10">
                  <div className="flex items-start gap-6 py-4 border-b border-white/[0.08]">
                    <span className="font-mono text-[11px] tracking-[0.1em] uppercase text-forge-paper/50 w-24 shrink-0 pt-0.5">
                      Materials
                    </span>
                    <p className="font-sans text-[14px] font-light text-forge-paper/80">
                      {product.materials}
                    </p>
                  </div>
                  <div className="flex items-start gap-6 py-4 border-b border-white/[0.08]">
