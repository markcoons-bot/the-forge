...
export const BODY_DARK = `${BODY} text-forge-paper/90`;
...
export const STORY_DARK = `${BODY_STORY} text-forge-paper/90`;
...
export const SECTION_LABEL_DARK = `${SECTION_LABEL} text-forge-paper/60`;
...
export const NAV_LINK_DARK = `${NAV_LINK} text-forge-paper/55 hover:text-forge-paper transition-colors duration-300`;
...
// ── Product Card ──
export const PRODUCT_NAME = "font-serif text-[17px] font-light";
export const PRODUCT_MAKER = "font-sans text-[14px] font-light mt-0.5";
export const PRODUCT_PRICE = "font-mono text-[15px] shrink-0";
